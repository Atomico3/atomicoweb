...
export const Noticias = () => {
  ...
  const noticias = [
	  {imagen: mogna, title:  t("ARGENTINA CIERRA LA PRIMERA TOKENIZACION DE LITIO A NIVEL MUNDIAL"), subtitle: "Territorio Blockchain",link: "https://territorioblockchain.com/argentina-cierra-la-primera-tokenizacion-de-litio-a-nivel-mundial/" },
